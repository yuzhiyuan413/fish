ReportGenerator.configure do
  section :hourly_charge_activity do
  ...
  section :hourly_charge_activity_cmcc do
    data_source DailyDs::ReportRequestHistory
    distinct_count :uuid
    condition do
      request_time params(:date).all_day
  ...
  section :hourly_charge_activity_cucc do
    data_source DailyDs::ReportRequestHistory
    distinct_count :uuid
    condition do
      request_time params(:date).all_day
  ...
  section :hourly_charge_activity_ctcc do
    data_source DailyDs::ReportRequestHistory
    distinct_count :uuid
    condition do
      request_time params(:date).all_day
  ...
  section :hourly_charge_activity_others_sp do
    data_source DailyDs::ReportRequestHistory
    distinct_count :uuid
    condition do
      request_time params(:date).all_day
  ...
  report :hourly_charge_activity do
    ...
    field :activity_num, :request_times  do
      section :hourly_charge_activity
      columns :tag, :loader_version_short, :province_id, :count_distinct_uuid, :count_id
    end

    field :cmcc_num  do
      section :hourly_charge_activity_cmcc
      columns :tag, :loader_version_short, :province_id, :count_distinct_uuid
    end

    field :cucc_num  do
      section :hourly_charge_activity_cucc
      columns :tag, :loader_version_short, :province_id, :count_distinct_uuid
    end

    field :ctcc_num do
      section :hourly_charge_activity_ctcc
      columns :tag, :loader_version_short, :province_id, :count_distinct_uuid
    end

    field :others_sp_num  do
      section :hourly_charge_activity_others_sp
      columns :tag, :loader_version_short, :province_id, :count_distinct_uuid
    end
