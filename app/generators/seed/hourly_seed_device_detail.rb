...
ReportGenerator.configure do
  	section :hourly_seed_device_detail do
    ...
    section :hourly_seed_device_detail_succ do
      data_source DailyDs::SeedFeedbackHistory
      distinct_count :did
      condition do
        record_time params(:date).all_day
  	...
  	report :hourly_seed_device_detail do
      ...
      field :count do
        section :hourly_seed_device_detail
        columns :tag, :brand, :model, :count_distinct_did
      end

      field :success_count do
        section :hourly_seed_device_detail_succ
        columns :tag, :brand, :model, :count_distinct_did
      end
