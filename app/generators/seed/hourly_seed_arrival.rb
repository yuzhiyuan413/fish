ReportGenerator.configure do
	section :hourly_seed_activation_aid do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition do
	...
	section :hourly_seed_cross_solution_active do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		...
		join "inner join daily_report.seed_feedback_histories on daily_report.seed_feedback_histories.aid = daily_report.seed_aid_users.aid"
		group :tag
    	sum_group :tag, Distributers::TagDistributer
	end

	section :hourly_seed_cross_solution_executing do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_solution_executied do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_solution_successed do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_solution_installed do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_solution_started do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_solution_failed do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_solution_v8 do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_solution_v9 do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.seed_feedback_histories.record_time > ?", params(:date).beginning_of_day]
	...
	section :hourly_seed_cross_v9_activity do
		data_source DailyDs::SeedAidUser
		distinct_count "seed_aid_users.aid"
		condition ["daily_report.seed_aid_users.record_time between ? and ?", params(:date).beginning_of_day, params(:date).end_of_day]
		condition ["daily_report.smart_request_histories.record_time > ?", params(:date).beginning_of_day]
		join "inner join daily_report.smart_request_histories on daily_report.smart_request_histories.aid = daily_report.seed_aid_users.aid"
		group :tag
		sum_group :tag, Distributers::TagDistributer
	end

	report :hourly_seed_arrival do
	    ...
	    field :seed_activation  do
	      section :hourly_seed_activation_aid
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

        field :seed_active  do
	      section :hourly_seed_cross_solution_active
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_executing  do
	      section :hourly_seed_cross_solution_executing
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_executied  do
	      section :hourly_seed_cross_solution_executied
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_successed  do
	      section :hourly_seed_cross_solution_successed
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_installed  do
	      section :hourly_seed_cross_solution_installed
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_started  do
	      section :hourly_seed_cross_solution_started
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_failed  do
	      section :hourly_seed_cross_solution_failed
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_v8_exists  do
	      section :hourly_seed_cross_solution_v8
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :seed_v9_exists  do
	      section :hourly_seed_cross_solution_v9
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end

	    field :v9_activity  do
	      section :hourly_seed_cross_v9_activity
	      columns :tag, :count_distinct_seed_aid_users_aid
	    end
